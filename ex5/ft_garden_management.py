...
def test_garden_management():
    ...
    try:
        ...
        for plant in plants:
            garden.plant_health(
                plant["plant"], plant["water_level"], plant["sunlight_hours"]
            )
